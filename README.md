...
- `docs/cli-reference.md` — Linux command reference and workflow index
- `.agents/skills/cfwarp-local-remote-ops/SKILL.md` — local tmux-first ops workflow and remote Linux deployment guidance
- `.agents/skills/cfwarp-local-remote-ops/references/cli-command-reference.md` — command reference for first-run local + remote usage
